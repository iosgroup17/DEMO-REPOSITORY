...
class AnalyticsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // 1. MODERN CHANGE: Use UIAction instead of #selector to avoid @objc requirement
    ...
    // This is now a standard Swift function (No @objc needed!)
    ...
    @IBAction func didTapDismissSuggestion(_ sender: UIButton) {
        ...
        // Using standard animation for simple one-off changes
    ...
    func showToast(message: String, isSuccess: Bool) {
        // Setup the toast view (kept logic similar to your original UI setup)
        ...
        // 2. MODERN CHANGE: Using Swift Concurrency (Task and await)
        Task {
            // Animate In
            ...
            // 3. CONCURRENCY CHANGE: Replace delay timer with Task.sleep
